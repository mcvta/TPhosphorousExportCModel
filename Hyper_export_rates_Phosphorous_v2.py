...
parameter_space = {'Agric': hp.uniform('Agric', 0.01, 5),
                   'Past': hp.uniform('Past',  0.01, 5), 
                   'Agroforestry': hp.uniform('Agroforestry',  0.01, 5),
                   'Forest': hp.uniform('Forest',  0.01, 5),
                  'Shrubland': hp.uniform('Shrubland', 0.01, 5) }
...
def model(parameters):
    ...
    Agroforestry = parameters['Agroforestry']
    Forest = parameters['Forest']
    Shrubland = parameters['Shrubland']
    Open_spaces = 0.0
    Wetland = 0.0
    Waterbodies = 0.0
...
result_sorted .to_csv('result_all.csv') 
